...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  // Profession type dropdown (individual only)
  String? _selectedProfessionType;
  final List<String> _professionTypes = [
    'MUSICIAN',
    'PHOTOGRAPHER',
  ...
  // Business type dropdown (business only)
    ...
    try {
      await AuthService.register(
        ...
        professionalType: _accountType == AccountType.individual
            ? _selectedProfessionType
            : null,
        businessType:
            _accountType == AccountType.business ? _selectedBusinessType : null,
                  ...
                  items: _professionTypes
                      .map((type) => DropdownMenuItem<String>(
                            ...
                            child: Text(
                              type,
                              style:
                                  AppFonts.body(color: AppColors.textPrimary),
                            ),
                          ))
                      .toList(),
                  onChanged: (value) {
